...
export default function Map() {
  return (
    <>
      <section className="bg-[#FAC663] pt-10 md:pt-0">
        <div className="mt-17.5 flex flex-col md:flex-row items-center max-w-[1366px] mx-auto pl-4">
          <div className="flex mb-10 max-w-[970px] mr-auto">
            <div>
              <h3 className="text-black1 font-bold md:text-4xl text-3xl leading-8 mb-10 lg:mb-12">
                Как нас найти
              </h3>
              <ul className="flex flex-col md:gap-7 lg:gap-9 max-w-[227px]">
                <li>
                  <h4 className="font-bold text-black1 text-[16px] leading-4 mb-4">
                    Адрес
                  </h4>
                  <p className="text-black1 leading-4">
                    Санкт-Петербург, <br />
                ...
                <li>
                  ...
                  <p className="text-black1">Ежедневно, с 9:00 до 20:00</p>
                </li>
                <li>
                  <h4 className="font-bold text-black1 text-[16px] leading-4 mb-4">
                    Телефон
                  </h4>
                  <a href="tel: 8 (800) 333-55-99" className="text-black1">
                    8 (800) 333-55-99
                  </a>
                </li>
                <li>
          ...
          <div className="max-w-[798px] overflow-hidden">
            <iframe
              className="max-w-[798px] hidden lg:flex h-[580px]"
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d193357.1200094905!2d72.15483343641667!3d40.77950711378732!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x38bc901d6b13d4ef%3A0xfc45bcaa7973dfac!2sAndijon%2C%20Andijon%20Viloyati%2C%20O%60zbekiston!5e0!3m2!1suz!2s!4v1717063420453!5m2!1suz!2s"
              style={{ border: 0 }}
              allowFullScreen=""
              loading="lazy"
            ...
            />
            <iframe
              className="max-w-[400px] min-h-[522px] lg:hidden hidden md:flex"
              src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d96631.04084605572!2d72.30280527373046!3d40.812145758011894!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1suz!2s!4v1717132918317!5m2!1suz!2s"
              width={400}
              height={522}
              style={{ border: 0 }}
              allowFullScreen=""
